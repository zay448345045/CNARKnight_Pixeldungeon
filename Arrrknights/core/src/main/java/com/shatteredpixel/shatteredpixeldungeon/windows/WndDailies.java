...
public class WndDailies extends Window {
    ...
    public WndDailies(){
        ...
        IconTitle title = new IconTitle(Icons.AMIYA.get(), Messages.get(this, "title"));
        ...
        if (Rankings.INSTANCE.latestDailyReplay != null){
            IconButton replayInfo = new IconButton(Icons.get(Icons.AMIYA)){
                @Override
                protected void onClick() {
                    TomorrowRogueNight.scene().addToFront(new WndRanking(Rankings.INSTANCE.latestDailyReplay));
                }
        ...
        for (long l : dates) {
            ...
            if (first){
                IconButton latestInfo = new IconButton(Icons.INFO.get()){
                    @Override
                    protected void onClick() {
                        TomorrowRogueNight.scene().addToFront(new WndRanking(Rankings.INSTANCE.latestDaily));
                    }
                };
